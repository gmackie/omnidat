...
For earlier camps and portable demos (including potential CC Camp 2027 rehearsals and ToorCamp 2028 village ops), the Field Office kit can run a smaller
...
CC Camp 2027 target: lighter kit with meshtastic/meshcore emphasis, no full PRI required.

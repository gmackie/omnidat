import { and, eq, isNull } from "@omnidat/db";
import { db } from "@omnidat/db/client";
import { apiKeys, user } from "@omnidat/db/schema";
import { getMetrics, SpanStatusCode, trace } from "@omnidat/telemetry";
...
const tracer = trace.getTracer("@omnidat/api");

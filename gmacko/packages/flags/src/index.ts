/**
 * @omnidat/flags - Runtime Feature Flags
 *
 ...
 * - @omnidat/flags/react - React hooks and components
 * - @omnidat/flags/server - Server-side helpers for tRPC
 *
 * @example
 * ```ts
 * // Basic usage
 * import { isEnabled, getFlag, getAllFlags } from "@omnidat/flags";
 *

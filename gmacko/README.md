...
> - SaaS layers: none selected
> - Default deploy path: ForgeGraph + Nix + colocated Postgres
> - Deploy tooling: @forgegraph/cli
> - Workers lane: not scaffolded
> - Mobile iteration: not scaffolded
> - Claude SaaS bootstrap pack: not scaffolded
> - Operator lane: CLI + MCP wrappers over the same tRPC API
>
